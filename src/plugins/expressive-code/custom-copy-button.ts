...
function svgElement(className: string[], d: string): Element {
	return {
		type: "element",
		tagName: "svg",
		properties: {
		...
		children: [
			{
				...
				children: [
					svgElement(["copy-btn-icon", "copy-icon"], COPY_ICON_PATH),
					svgElement(["copy-btn-icon", "success-icon"], SUCCESS_ICON_PATH),
				],
			},
		],
	} as Element;
